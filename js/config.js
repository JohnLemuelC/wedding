...
window.WEDDING = {
  ...
  venues: [
    {
      ...
      listedAs: "Kevin's KVN Resort & Catering",
      plusCode: "W8HJ+5FV, San Carlos City, Pangasinan",
      // Google Maps share link for the listing (opens the place page, and the app on phones)
      mapUrl: "https://maps.app.goo.gl/mYcusUttqtHpCzAQ9",
      // Map on the page, pinned to the same listing
      mapEmbed: "https://maps.google.com/maps?cid=500690258979706595&z=16&output=embed",
      coordinates: "15.9279979,120.3311749"
    }
  ],
  ...
  faq: [
    ...
    { q: "Where is the wedding?", a: "At KVN Resort in Mamarlao, San Carlos City, Pangasinan. On Google Maps it's listed as Kevin's KVN Resort & Catering (plus code W8HJ+5FV). There's a map in the How to Get There section." },
